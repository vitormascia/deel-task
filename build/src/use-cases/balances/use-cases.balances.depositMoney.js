...
function buildDepositMoney({ profileRepository, jobRepository, contractRepository, db, }) {
    return async function depositMoney(profileId, userId, deposit) {
        ...
        const depositorTotalOfJobsToPay = clientDepositorContracts.reduce(function (acc, contract) {
...
//# sourceMappingURL=use-cases.balances.depositMoney.js.map